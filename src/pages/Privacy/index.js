...
const Index = () => {
  ...
  return (
    <div>
      <Header />
      <div className="login-style d-flex flex-column align-items-center align-self-stretch p-0 m-0">
          ...
          >
            ...
            <div className="row m-0 p-0">
              ...
              <div className="col-12">
                <h5>2. Definitions</h5>
                <p>
                  SERVICE means the www.tomati.app website and Tomati.app mobile
                  application operated by ZontLabs OÜ.
                  <br />
              ...
              <div className="col-12">
                ...
                <p>
                  ...
                  unsubscribe link or by emailing at hello@tomati.app.
                  <br />
                  ...
                  other diagnostic data. Location Data
                  <br />
              ...
              <div className="col-12">
                ...
                <p>
                  ...
                  to valid requests by public authorities. (b) Business
                  Transaction.
                  <br />
              ...
              <div className="col-12 p-0">
                ...
                <p>
                  ...
                  you to review the Google's policy for safeguarding your data:
              ...
              <div className="col-12 p-0">
                ...
                <p>
                  ...
                  please visit Facebook's Data Policy: https://www.facebook.com
                  <br />
                  /privacy/explanation
                </p>
              </div>
